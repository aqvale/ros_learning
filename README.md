...
- **Things to install**
  ...
  - [Trello](https://trello.com/) - Extensão for Chrome: [`Plus for Trello`](https://chrome.google.com/webstore/detail/plus-for-trello-time-trac/gjjpophepkbhejnglcmkdnncmaanojkf?hl=pt-BR); [`Card colors for trello`](https://chrome.google.com/webstore/detail/trello-cards-optimizer/ipbjjbpopodbnjbjnneakhcppdocpelg?hl=pt-BR)
